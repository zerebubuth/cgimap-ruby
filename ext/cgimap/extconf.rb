...
abort "missing boost::system" unless have_library('boost_system', 'auto ec = boost::system::errc::make_error_code(boost::system::errc::not_supported)','boost/system/error_code.hpp')
